# Utility to reduce number of training image files to a target number of images
# In this case images are randomly deleted until target of 800 is reached
import os
import glob
import random

def reduce_files_in_subdir(subdir_path, target_file_count=800):
...
# Base directory path
base_dir_path = '/path/to/training/dir'
